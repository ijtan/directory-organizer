...
data = ['.csv','.txt','.json','.yaml','.xlsx','.xls','.xlsm','.sql','.html','.data','.xml','.cfg', '.log', '.bib', '.ris']
media = ['.png','.jpg','.mp3','.mp4','.m4v','.mkv','.swf','.flv','.avi','.gif','.wav','.webm','.bmp','.jpeg','.ico','.ps','.psd','.svg', '.webp']
